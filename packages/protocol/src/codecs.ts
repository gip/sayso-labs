...
import type { JsonPayload } from "./types.js";
...
export const saysoCodecs: ContentCodec<JsonPayload>[] = [
  ...
  new JsonContentCodec(CONTENT_TYPES.registrationRemove, "SaySo network registration remove"),
  new JsonContentCodec(CONTENT_TYPES.agentQuery, "SaySo network agent query"),
  new JsonContentCodec(CONTENT_TYPES.agentQueryResponse, "SaySo network agent query response"),
  new JsonContentCodec(CONTENT_TYPES.agentGet, "SaySo network agent get"),
  new JsonContentCodec(CONTENT_TYPES.agentGetResponse, "SaySo network agent get response"),
