...
export const PONG_RUNTIME_SOURCE_PATH = "apps/cli/src/pong/runtime-app.js";
export const PONG_RUNTIME_BYTECODE_PATH = "apps/cli/src/pong/runtime-app.qjsc";

export const PONG_SOURCE_PATHS = [
  "apps/cli/package.json",
  "apps/cli/scripts/copy-runtime-app.mjs",
  "apps/cli/tsconfig.json",
  "apps/cli/src/cli/options.ts",
  "apps/cli/src/cli/pong-agent.ts",
  "apps/cli/src/pong/application.ts",
  "apps/cli/src/pong/configuration.ts",
  "apps/cli/src/pong/handler.ts",
  "apps/cli/src/pong/networkRegistration.ts",
  "apps/cli/src/pong/quickjs.ts",
  PONG_RUNTIME_SOURCE_PATH,
  PONG_RUNTIME_BYTECODE_PATH,
  "apps/cli/src/pong/source.ts",
  "apps/cli/src/pong/skill.ts",
  "apps/cli/src/pong/types.ts",
  "apps/cli/src/sayso/codecs.ts",
  "apps/cli/src/sayso/constants.ts",
  "apps/cli/src/sayso/contentTypes.ts",
  "apps/cli/src/sayso/identity.ts",
  "apps/cli/src/sayso/markdown.ts",
  "apps/cli/src/sayso/protocol.ts",
  "apps/cli/src/sayso/quickjs.ts",
  "apps/cli/src/sayso/types.ts",
  "apps/cli/src/sayso/validation.ts",
  "apps/cli/src/sayso/xmtp.ts",
