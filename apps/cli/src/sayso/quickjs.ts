...
export type SaySoQuickJsSigner = SaySoRuntimeSigner;
export type SaySoQuickJsNetworkPolicyInput = SaySoRuntimeNetworkPolicyInput;
export type SaySoQuickJsNetwork = SaySoRuntimeNetwork;
export type SaySoQuickJsLocalText = SaySoRuntimeLocalText;
export type SaySoQuickJsHostOptions = SaySoRuntimeHostOptions;
export type SaySoQuickJsApplication = SaySoRuntimeApplication;
...
export const createQuickJsApplication = async (
  ...
  const registerApplication = vm.newFunction("registerApplication", (appHandle) => {
    ...
    application = {
      ...
      ...(isRecord(metadata.source) ? { source: metadata.source as SaySoRuntimeApplication["source"] } : {}),
